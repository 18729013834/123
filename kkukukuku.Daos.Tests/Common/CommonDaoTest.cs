...
/*add customized code between this region*/
namespace kkukukuku.Daos.Tests.Common
{
	...
	where TDdlBuilder : DdlBuilder, new()
	{
		...
		public void BasicSetUp()
		{
			...
			DaoFactory.Instance.ConnectionStringBuilder = new SqlCeConnectionStringBuilder("kkukukuku.Entities", baseDirectory, null);
